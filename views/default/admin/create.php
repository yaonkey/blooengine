                ...
                <?php else : ?>
                    ...
                    <div class="signup-form"><!--first sign up form-->
                        ...
                        <form action="#" method="post">
                            <input type="email" name="site_email" placeholder="E-mail сайта" value="<?= $siteEmail ?>" />
                            <input type="password" name="site_password" placeholder="Пароль" value="<?= $sitePassword ?>" />
                            <input type="text" name="site_name" placeholder="Наименование сайта" value="<?= $siteName ?>" />
